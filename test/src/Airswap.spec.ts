...
describe('AirSwap Integration Tests', async () => {
    ...
    async function createSignedOrder(params: any, signer: any) {
        ...
        // console.log(" Order hash: ",getOrderHash(unsignedOrder,hswap.address).toString("hex"))
        console.log(" Order hash: ", getOrderHash(unsignedOrder, hswap.address).toString("hex"))
    ...
    before('get signers and deploy', async () => {
        ...
        console.log("fee rule registry address:", feeRuleRegistry.address);
        ...
        console.log("swaping address:", hswap.address);
    ...
    it("Registr handlers", async function () {
        const a = await registry.connect(signer).register(hswap.address, ethers.utils.formatBytes32String("HAirSwap"));
    ...
    describe('Test Swap', async () => {
        it('Swap Token', async () => {
            ...
            await proxyMock.connect(sender).execMock(to, data);
